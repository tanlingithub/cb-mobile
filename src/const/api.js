...
// 登录注册
export const login = `${baseUrl}${version}/kabin/login`

// 查询用户信息
export const findByID = `${baseUrl}${version}/user/findUserById`
...
// 商品加入购物车
export const addToCart = `${baseUrl}${version}/common/addOne?collection=cart`

// 获取购物车商品
export const getCartGoods = `${baseUrl}${version}/common/findAllByCondition?collection=cart`

// 更新购物车商品数量
export const setCartGoods = `${baseUrl}${version}/common/updateCart`
...
// 获取角色所有的流程列表
export const channelDetail = `${baseUrl}${version}/common/show`

export const apply = `${baseUrl}${version}/kabin/apply/apply`
export const reject = `${baseUrl}${version}/kabin/apply/reject`
